...
var material_Conditional = materialConditional(argOne, argTwo), exclusive_Or = exclusiveOR(argOne, argTwo);
...
function evaluateMaterialConditionalAndExclusiveOr(material_Conditional, exclusive_Or){
